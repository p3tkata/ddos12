...
=end
=cut
print "CODED BY BUKSNA";
#!/usr/bin/perl

#~> [-------------------------------] <~#
#~> [ Discord: buksnica#1545        ] <~#
#~> [ Website: Black-net.pw         ] <~#
#~> [ Github: github.com/420buksna  ] <~#
#~> [-------------------------------] <~#
...
if($#ARGV > 3) {
    ...
    print("
[+]---------------------------------------------------------------[+]
                   P-DoS v1.0 - Moded by PassDDoS                   
[+]---------------------------------------------------------------[+]
--> Use: bhttp.pl [Url] [Connection] [Threads] [GET/POST/HEAD] [Proxy]
--> Ex : bhttp.pl http://target.com 9999 1000 GET 82.137.250.145:8080\n");
}